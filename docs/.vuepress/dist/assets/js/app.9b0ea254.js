        ...
        e.push(
          (r[t] = new Promise(function(e, n) {
            for (
              ...
              var c = (l = a[s]).getAttribute("data-href") || l.getAttribute("href");
              if ("stylesheet" === l.rel && (c === r || c === o)) return e();
            }
            var u = document.getElementsByTagName("style");
            for (s = 0; s < u.length; s++) {
              var l;
              if ((c = (l = u[s]).getAttribute("data-href")) === r || c === o) return e();
            }
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e) {
      ...
      return function(e, s, h) {
        for (
          var v, m, g = i(e), y = o(g), b = r(s, h, 3), _ = a(y.length), x = 0, k = n ? d(e, _) : c ? d(e, 0) : void 0;
          _ > x;
          x++
        )
 ...
 * @license MIT */ void 0 ===
        ...
        typeof (r = function() {
          ...
          (t.configure = function(t) {
                  ...
                  "" === e.positionUsing && (e.positionUsing = t.getPositioningCSS()),
                          ...
                          ((i =
                            "translate3d" === e.positionUsing
                              ...
                              : "translate" === e.positionUsing
                                ...
                                : { "margin-left": r(t) + "%" }).transition = "all " + n + "ms " + o),
                          i
                        );
                      })(a, l, f)
                    ),
                    1 === a
                      ? (i(c, { transition: "none", opacity: 1 }),
                        c.offsetWidth,
                        setTimeout(function() {
                          i(c, { transition: "all " + l + "ms linear", opacity: 0 }),
                            setTimeout(function() {
                              t.remove(), n();
                            }, l);
                        }, l))
            ...
            (t.render = function(n) {
              ...
              return (
                i(c, { transition: "all 0 linear", transform: "translate3d(" + u + "%,0,0)" }),
                e.showSpinner || ((a = o.querySelector(e.spinnerSelector)) && l(a)),
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n, h, v, m, g) {
      ...
      if (
        ...
        if (((y = { values: w ? O : x("values"), keys: m ? O : x("keys"), entries: E }), g))
                  ...
                  try {
                    s
                      ? (o || (2 == t._h && R(t), (t._h = 1)),
                        ...
                        n === e.promise ? u(w("Promise-chain cycle")) : (i = L(n)) ? i.call(n, c, u) : c(n))
                      : u(r);
                  } catch (t) {
                    l && !a && l.exit(), u(t);
                  }
    ...
    n(66)("split", 2, function(t, e, r) {
      ...
      if (
        ...
        r = function(t, e) {
          ...
          return (
            h === n.length ? (!l && m.test("")) || p.push("") : p.push(n.slice(h)), p.length > v ? p.slice(0, v) : p
          );
        };
      } else
  ...
  function(t, e, n) {
    ...
    if (
      ...
      (!h ||
        n(5)(function() {
          return (d[n(1)("match")] = !1), u(p) != p || u(d) == d || "/a/i" != u(p, "i");
        }))
    ) {
      u = function(t, e) {
        ...
        return !n && r && t.constructor === u && i
          ? t
          : o(
              h ? new l(r && !i ? t.source : t, e) : l((r = t instanceof u) ? t.source : t, r && i ? c.call(t) : e),
              n ? this : f,
              u
            );
      };
      for (
        ...
        v(m[g++]);
      (f.constructor = u), (u.prototype = f), n(9)(r, "RegExp", u);
    }
    n(59)("RegExp");
  },
  function(t, e, n) {
    ...
    t.exports = {
      set:
        ...
        ("__proto__" in {}
          ? (function(t, e, r) {
              try {
                (r = n(10)(Function.call, n(124).f(Object.prototype, "__proto__").set, 2))(t, []),
    ...
    t.exports = function(t, e, n, v, m, g) {
      ...
      if (
        ...
        O ||
          ...
          (x.constructor = b)),
          (S || E) && (w("delete"), w("has"), m && w("get")),
          (E || $) && w(_),
          g && x.clear && delete x.clear;
      } else (b = v.getConstructor(e, t, m, _)), a(b.prototype, n), (s.NEED = !0);
      return d(b, t), (k[t] = b), o(o.G + o.W + o.F * (b != y), k), g || v.setStrong(b, t, m), b;
    };
  },
  function(t, e, n) {
    "use strict";
  ...
  function(t, e, n) {
    ...
    var nt = function() {
        return (
          void 0 === q && (q = !W && !z && "undefined" != typeof global && "server" === global.process.env.VUE_ENV), q
        );
      },
    ...
    var wt = function(t) {
      ((this.value = t), (this.dep = new ut()), (this.vmCount = 0), B(t, "__ob__", this), Array.isArray(t))
        ? ((V ? Ct : $t)(t, bt, _t), this.observeArray(t))
        : this.walk(t);
    };
    function Ct(t, e, n) {
      t.__proto__ = e;
    ...
    function St(t, e) {
      ...
      if (c(t) && !(t instanceof dt))
        return (
          b(t, "__ob__") && t.__ob__ instanceof wt
            ? (n = t.__ob__)
            : xt && !nt() && (Array.isArray(t) || l(t)) && Object.isExtensible(t) && !t._isVue && (n = new wt(t)),
          e && n && n.vmCount++,
          n
        );
    }
    ...
    function jt(t, e) {
      ...
      for (var n, r, o, i = Object.keys(e), a = 0; a < i.length; a++)
        (r = t[(n = i[a])]), (o = e[n]), b(t, n) ? l(r) && l(o) && jt(r, o) : Et(t, n, o);
      return t;
    }
    function Lt(t, e, n) {
      return n
      ...
      "function" == typeof e && (e = e.options),
        (function(t, e) {
          ...
          if (n) {
            ...
            else if (l(n)) for (var a in n) (o = n[a]), (i[k(a)] = l(o) ? o : { type: o });
            t.props = i;
          }
        })(e),
        (function(t, e) {
    ...
    if ("undefined" != typeof setImmediate && ot(setImmediate))
      ...
      (!ot(MessageChannel) && "[object MessageChannelConstructor]" !== MessageChannel.toString())
    )
      zt = function() {
        setTimeout(Xt, 0);
      };
    ...
    function ae(t, e, n, r, i) {
      ...
      for (a in t)
        (s = t[a]),
          ...
          o(s) ||
            (o(c)
              ? (o(s.fns) && (s = t[a] = ie(s)), n(u.name, s, u.once, u.capture, u.passive, u.params))
              : s !== c && ((c.fns = s), (t[a] = c)));
          ...
          ? (function t(e, n) {
              ...
              for (c = 0; c < e.length; c++)
                o((u = e[c])) ||
                  ...
                  Array.isArray(u)
                    ? u.length > 0 &&
                      (le((u = t(u, (n || "") + "_" + c))[0]) && le(f) && ((r[l] = mt(f.text + u[0].text)), u.shift()),
                      r.push.apply(r, u))
                    : s(u)
                      ? le(f)
                        ? (r[l] = mt(f.text + u))
    ...
    function Te() {
      ...
      for (
        ...
        (e = (t = Ce[Ae]).id), (Se[e] = null), t.run();
      var n = $e.slice(),
        r = Ce.slice();
      (Ae = Ce.length = $e.length = 0),
        (Se = {}),
        (Oe = Ee = !1),
        (function(t) {
    ...
    var Pe = { enumerable: !0, configurable: !0, get: T, set: T };
    function Ie(t, e, n) {
      (Pe.get = function() {
        return this[e][n];
      }),
        ...
        e.computed &&
          (function(t, e) {
            ...
            for (var o in e) {
              ...
              0, r || (n[o] = new Le(t, a || T, T, Re)), o in t || Ne(t, o, i);
            }
          })(t, e.computed),
        e.watch &&
          e.watch !== Z &&
    ...
    function Ne(t, e, n) {
      var r = !nt();
      "function" == typeof n
        ? ((Pe.get = r ? De(e) : n), (Pe.set = T))
        : ((Pe.get = n.get ? (r && !1 !== n.cache ? De(e) : n.get) : T), (Pe.set = n.set ? n.set : T)),
    ...
    function Ge(t, e) {
      ...
      return r && !e
        ? r
        : (Xe((r = n[t] = this.$options.staticRenderFns[t].call(this._renderProxy, null, this)), "__static__" + t, !1),
          r);
    }
    function Ke(t, e, n) {
    ...
    var nn = {
        ...
        prepatch: function(t, e) {
          ...
          !(function(t, e, n, o, i) {
            ...
            (t.$options._parentListeners = n), me(t, n, p), a && ((t.$slots = ge(i, o.context)), t.$forceUpdate());
    ...
    !(function(t) {
      ...
      Object.defineProperty(t, "config", e),
        (t.util = { warn: st, extend: E, mergeOptions: Rt, defineReactive: Ot }),
        (t.set = Et),
        (t.delete = At),
        (t.nextTick = te),
        ...
        (function(t, e) {
          ...
          for (n in c)
            (r = s[n]),
              (o = c[n]),
              r
                ? ((o.oldValue = r.value), Yn(o, "update", e, t), o.def && o.def.componentUpdated && l.push(o))
    ...
    function Kn(t, e) {
      ...
      for (n = 0; n < t.length; n++)
        (r = t[n]).modifiers || (r.modifiers = Gn), (o[Xn(r)] = r), (r.def = Nt(e.$options, "directives", r.name));
      return o;
    }
    function Xn(t) {
    ...
    function Qn(t, e) {
      ...
      if (!((i(n) && !1 === n.Ctor.options.inheritAttrs) || (o(t.data.attrs) && o(e.data.attrs)))) {
        var r,
          ...
          c = t.data.attrs || {},
          u = e.data.attrs || {};
        for (r in (i(u.__ob__) && (u = e.data.attrs = E({}, u)), u)) (a = u[r]), c[r] !== a && Zn(s, r, a);
        for (r in ((X || J) && u.value !== c.value && Zn(s, "value", u.value), c))
          o(u[r]) && ($n(r) ? s.removeAttributeNS(Cn, Sn(r)) : kn(r) || s.removeAttribute(r));
      }
    }
    function Zn(t, e, n) {
      t.tagName.indexOf("-") > -1
    ...
    function nr(t, e) {
      ...
      if (!(o(r.staticClass) && o(r.class) && (o(a) || (o(a.staticClass) && o(a.class))))) {
        ...
        i(c) && (s = Tn(s, jn(c))), s !== n._prevClass && (n.setAttribute("class", s), (n._prevClass = s));
      }
    }
    var rr,
    ...
    var gr,
      ...
      xr = ["Webkit", "Moz", "ms"],
      kr = _(function(t) {
        if (((gr = gr || document.createElement("div").style), "filter" !== (t = k(t)) && t in gr)) return t;
        ...
        var d = (function(t, e) {
          ...
          if (e)
            for (var o = t; o.componentInstance; )
              (o = o.componentInstance._vnode) && o.data && (n = vr(o.data)) && E(r, n);
          (n = vr(t.data)) && E(r, n);
          for (var i = t; (i = i.parent); ) i.data && (n = vr(i.data)) && E(r, n);
          return r;
        })(e, !0);
    ...
    function Hr(t, e) {
      ...
      return (
        e === Tr
          ? a > 0 && ((n = Tr), (l = a), (f = i.length))
          : e === jr
            ? u > 0 && ((n = jr), (l = u), (f = c.length))
            : (f = (n = (l = Math.max(a, u)) > 0 ? (a > u ? Tr : jr) : null) ? (n === Tr ? i.length : c.length) : 0),
        { type: n, timeout: l, propCount: f, hasTransform: n === Tr && Br.test(r[Lr + "Property"]) }
      );
    }
    function qr(t, e) {
        ...
        if (!O || x || "" === x) {
          ...
          var N = !1 !== a && !Y,
            ...
            U = (n._enterCb = M(function() {
              N && (Ur(n, T), Ur(n, A)), U.cancelled ? (N && Ur(n, E), I && I(n)) : P && P(n), (n._enterCb = null);
            }));
          t.data.show ||
            ...
            N &&
              ...
              Dr(n, A),
              Nr(function() {
                Ur(n, E), U.cancelled || (Dr(n, T), D || (Gr(R) ? setTimeout(U, R) : Fr(n, s, U)));
              })),
      ...
      if (!i(n._leaveCb)) {
        ...
        var k = (n._leaveCb = M(function() {
          n.parentNode && n.parentNode._pending && (n.parentNode._pending[t.key] = null),
            b && (Ur(n, l), Ur(n, f)),
            k.cancelled ? (b && Ur(n, u), m && m(n)) : (e(), v && v(n)),
            (n._leaveCb = null);
        }));
        g ? g(w) : w();
      }
      function w() {
        k.cancelled ||
          ...
          b &&
            ...
            Dr(n, f),
            Nr(function() {
              Ur(n, u), k.cancelled || (Dr(n, l), _ || (Gr(x) ? setTimeout(k, x) : Fr(n, s, k)));
            })),
          d && d(n, k),
          b || _ || k());
      }
        ...
        if (
          ...
          !(function(t, e, n, o) {
            ...
            if (i(s)) {
              ...
              if ((i((s = s.hook)) && i((s = s.init)) && s(t, !1, n, o), i(t.componentInstance)))
                return (
                  p(t, e),
                  a(c) &&
                    (function(t, e, n, o) {
                            ...
                            : qn(m, _)
                              ...
                              : qn(v, _)
                                ? (C(v, _, r),
                                  ...
                                  (_ = n[--g]))
                                : qn(m, y)
                                  ? (C(m, y, r), k && u.insertBefore(t, m.elm, v.elm), (m = e[--h]), (y = n[++d]))
                                  : (o(s) && (s = Vn(e, p, h)),
                                    o((c = i(y.key) ? s[y.key] : w(y, e, p, h)))
                                      ? f(y, r, t, v.elm, !1, n, d)
                                      : qn((l = e[c]), y)
                                        ? (C(l, y, r), (e[c] = void 0), k && u.insertBefore(t, l.elm, v.elm))
                                        : f(y, r, t, v.elm, !1, n, d),
                                    (y = n[++d]));
                    p > h ? b(t, o(n[g + 1]) ? null : n[g + 1].elm, n, d, g, r) : d > g && x(0, e, p, h);
                  })(c, d, h, n, s)
                : i(h)
                  ? (i(t.text) && u.setTextContent(c, ""), b(c, null, h, 0, h.length - 1, n))
                  : i(d)
                    ? x(0, d, 0, d.length - 1)
        ...
        if (!o(e)) {
          ...
          if (o(t)) (p = !0), f(e, d, c, l);
            ...
            if (!h && qn(t, e)) C(t, e, d, s);
              ...
              if (h) {
                if ((1 === t.nodeType && t.hasAttribute(R) && (t.removeAttribute(R), (n = !0)), a(n) && O(t, e, d)))
                  return $(e, d, !0), t;
                t = (function(t) {
    ...
    function Zr(t, e, n) {
      ...
      if (!o || Array.isArray(r)) {
        for (var i, a, s = 0, c = t.options.length; s < c; s++)
          if (((a = t.options[s]), o)) (i = I(r, eo(a)) > -1), a.selected !== i && (a.selected = i);
    ...
    var fo = {
      ...
      po = E({ tag: String, moveClass: String }, so);
    function ho(t) {
                  ...
                  n.addEventListener(
                    ...
                    (n._moveCb = function t(r) {
                      (r && !/transform$/.test(r.propertyName)) ||
                        (n.removeEventListener(Pr, t), (n._moveCb = null), Ur(n, e));
                    })
                  );
              }
            }));
    ...
    (pn.config.mustUseProp = function(t, e, n) {
      ...
      (pn.config.isUnknownElement = function(t) {
        ...
        return t.indexOf("-") > -1
          ? (Rn[t] = e.constructor === window.HTMLUnknownElement || e.constructor === window.HTMLElement)
          : (Rn[t] = /HTMLUnknownElement/.test(e.toString()));
      }),
      E(pn.options.directives, ao),
      E(pn.options.components, go),
      (pn.prototype.__patch__ = W ? Yr : T),
    ...
    function Io(t, e) {
      return e === Lo
        ...
        : !!e &&
            (t.path && e.path
              ? t.path.replace(Ao, "") === e.path.replace(Ao, "") && t.hash === e.hash && Mo(t.query, e.query)
              : !(!t.name || !e.name) &&
                (t.name === e.name && t.hash === e.hash && Mo(t.query, e.query) && Mo(t.params, e.params)));
    }
    function Mo(t, e) {
      ...
      return (
        ...
        n.every(function(n) {
          var r = t[n],
            o = e[n];
          return "object" == typeof r && "object" == typeof o ? Mo(r, o) : String(r) === String(o);
        })
      );
    }
    var Ro,
      ...
      Uo = {
        ...
        render: function(t) {
          var e = this,
            ...
            v = i.path ? To(null, i, null, n) : a;
          (c[h] = Io(r, v)),
            (c[d] = this.exact
              ? c[h]
              : (function(t, e) {
                  return (
                    0 === t.path.replace(Ao, "/").indexOf(e.path.replace(Ao, "/")) &&
          ...
          if ("a" === this.tag) (y.on = g), (y.attrs = { href: s });
            ...
            if (b) {
              b.isStatic = !1;
              var _ = Ro.util.extend;
              ((b.data = _({}, b.data)).on = g), ((b.data.attrs = _({}, b.data.attrs)).href = s);
            } else y.on = g;
          }
    ...
    function Qo(t, e) {
      for (var n, r = [], o = 0, i = 0, a = "", s = (e && e.delimiter) || "/"; null != (n = Jo.exec(t)); ) {
        var c = n[0],
          u = n[1],
          l = n.index;
    ...
    function ei(t) {
      ...
      return function(n, r) {
        for (var o = "", i = n || {}, a = (r || {}).pretty ? Zo : encodeURIComponent, s = 0; s < t.length; s++) {
          var c = t[s];
          if ("string" != typeof c) {
            var u,
              l = i[c.name];
            ...
            if (Wo(l)) {
              ...
              if (((u = c.asterisk ? ti(l) : a(l)), !e[s].test(u)))
    ...
    function si(t, e, n) {
      return (
        ...
        t instanceof RegExp
          ...
          : Wo(t)
            ? (function(t, e, n) {
                for (var r = [], o = 0; o < t.length; o++) r.push(si(t[o], e, n).source);
    ...
    (zo.parse = Go), (zo.compile = Ko), (zo.tokensToFunction = Xo), (zo.tokensToRegExp = Yo);
    ...
    function di(t, e) {
      ...
      function a(t, n, a) {
        ...
        if (u) {
          ...
          if (l) return (s.path = ui(l.path, s.params)), c(l, s, a);
        } else if (s.path) {
          s.params = {};
          for (var d = 0; d < r.length; d++) {
            var h = r[d],
              v = o[h];
            if (hi(v.regex, s.path, s.params)) return c(v, s, a);
          }
        }
        return c(null, s);
      }
      function s(t, n) {
        var r = t.redirect,
          o = "function" == typeof r ? r(To(t, n, null, e)) : r;
        ...
        if (l) {
          ...
          return a({ _normalized: !0, path: ui(h, d), query: f, hash: p }, void 0, n);
        }
        return c(null, n);
      }
      function c(t, n, r) {
    ...
    function _i(t) {
      return { x: xi(t.x) ? t.x : window.pageXOffset, y: xi(t.y) ? t.y : window.pageYOffset };
    }
    function xi(t) {
    ...
    var wi =
      ...
      Ci = Ho && window.performance && window.performance.now ? window.performance : Date,
      $i = Si();
    function Si() {
      return Ci.now().toFixed(3);
    }
    function Oi() {
      return $i;
    }
    function Ei(t, e) {
      ...
      try {
        e ? n.replaceState({ key: $i }, "", t) : (($i = Si()), n.pushState({ key: $i }, "", t));
      } catch (n) {
        ...
        Li(t, function(t, e, n, s) {
          if ("function" == typeof t && void 0 === t.cid) {
            ...
            var c,
              u = Mi(function(e) {
                (function(t) {
                  return t.__esModule || (Ii && "Module" === t[Symbol.toStringTag]);
                })(e) && (e = e.default),
    ...
    var Ii = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag;
    function Mi(t) {
      var e = !1;
      return function() {
        for (var n = [], r = arguments.length; r--; ) n[r] = arguments[r];
    ...
    (Ri.prototype.listen = function(t) {
      ...
      (Ri.prototype.confirmTransition = function(t, e, n) {
        ...
        if (Io(t, o) && t.matched.length === o.matched.length) return this.ensureURL(), i();
        var a = (function(t, e) {
            var n,
            ...
            window.addEventListener(wi ? "popstate" : "hashchange", function() {
              ...
              Hi() &&
                t.transitionTo(qi(), function(r) {
                  n && gi(t.router, r, e, !0), wi || zi(r.fullPath);
                });
            });
        }),
        (e.prototype.push = function(t, e, n) {
    ...
    function Wi(t) {
      wi ? Ei(Vi(t)) : (window.location.hash = t);
    }
    function zi(t) {
      wi ? Ai(Vi(t)) : window.location.replace(Vi(t));
    }
    var Gi = (function(t) {
        function e(e, n) {
    ...
    (Ki.prototype.match = function(t, e, n) {
      ...
      (Ki.prototype.addRoutes = function(t) {
        this.matcher.addRoutes(t),
          this.history.current !== Lo && this.history.transitionTo(this.history.getCurrentLocation());
      }),
    ...
    var Ji = Ki;
    n(102), n(18), n(30), n(12), n(22), n(50), n(32), n(65);
    function Qi(t) {
      return (
        (function(t) {
          if (Array.isArray(t)) {
    ...
    var ta = { disableScrollBehavior: !1 },
      ea = n(49),
      na = n.n(ea),
      ra = (n(20), n(109), n(111), n(33), n(112), n(84), n(23), /#.*$/),
      oa = /\.(md|html)$/,
      ia = /\/$/,
      aa = /^(https?:|mailto:|tel:)/;
    function sa(t) {
    ...
    function fa(t, e, n) {
      ...
      for (var r = sa(e), o = 0; o < t.length; o++)
        if (sa(t[o].path) === r) return Object.assign({}, t[o], { type: "page", path: ua(e) });
    ...
    function pa(t, e, n, r) {
      ...
      if (s) {
        var c = (function(t, e) {
            ...
            for (var n in e) if (0 === va(t.path).indexOf(n)) return { base: n, config: e[n] };
            return {};
          })(e, s),
          u = c.base,
          l = c.config;
        return l
          ? l.map(function(t) {
              return (function t(e, n, r, o) {
                ...
                if (Array.isArray(e)) return Object.assign(fa(n, e[0], r), { title: e[1] });
                o &&
                  console.error(
          ...
          return n(
            ...
            [
              n("div", { staticClass: "hero" }, [
                t.data.heroImage ? n("img", { attrs: { src: t.$withBase(t.data.heroImage), alt: "hero" } }) : t._e(),
                t._v(" "),
    ...
    wa.options.__file = "SidebarButton.vue";
    var Ca = wa.exports,
      $a = (n(117),
      {
        data: function() {
                ...
                if (this.getPageLocalePath(c) === o)
                  if (i(c)) a.push(c);
                    ...
                    for (var u = 0; u < c.headers.length && !(a.length >= r); u++) {
                      var l = c.headers[u];
                      i(l) && a.push(Object.assign({}, c, { path: c.path + "#" + l.slug, header: l }));
                    }
              }
              return a;
            }
        ...
        function() {
          ...
          return n("div", { staticClass: "search-box" }, [
            n("input", {
              ...
              on: {
                ...
                keyup: [
                  ...
                  function(e) {
                    return "button" in e || !t._k(e.keyCode, "down", 40, e.key, ["Down", "ArrowDown"])
                      ? t.onDown(e)
                      : null;
                  }
                ]
            ...
            t.showSuggestions
              ? n(
                  "ul",
                  { staticClass: "suggestions", class: { "align-right": t.alignRight }, on: { mouseleave: t.unfocus } },
    ...
    Aa.options.__file = "DropdownTransition.vue";
    var Ta = Aa.exports,
      ja = {
        components: { NavLink: ba, DropdownTransition: Ta },
        data: function() {
          return { open: !1 };
        },
        props: { item: { required: !0 } },
    ...
    var Pa = {
        components: { NavLink: ba, DropdownLink: La.exports },
        computed: {
          userNav: function() {
          ...
          userLinks: function() {
            return (this.nav || []).map(function(t) {
              return Object.assign(ha(t), { items: (t.items || []).map(ha) });
            });
          },
          repoLink: function() {
    ...
    var Na = {
        components: { SidebarButton: Ca, NavLinks: Ma, SearchBox: Oa, AlgoliaSearchBox: {} },
        data: function() {
          return { linksWrapMaxWidth: null };
        },
        mounted: function() {
          var t = this,
            e = parseInt(Ra(this.$el, "paddingLeft")) + parseInt(Ra(this.$el, "paddingRight")),
            n = function() {
        ...
        function() {
          ...
          return n(
            ...
            [
              ...
              n(
                "div",
                { staticClass: "links", style: { "max-width": t.linksWrapMaxWidth + "px" } },
                [
                  t.isAlgoliaSearch
          ...
          editLink: function() {
            if (!1 !== this.$page.frontmatter.editLink) {
              var t = this.$site.themeConfig,
                ...
                u = sa(this.$page.path);
              return (
                ia.test(u) ? (u += "README.md") : (u += ".md"), c && n ? this.createEditLink(e, c, o, a, u) : void 0
              );
            }
          },
        ...
        methods: {
          createEditLink: function(t, e, n, r, o) {
            return /bitbucket.org/.test(t)
              ...
              : (aa.test(e) ? e : "https://github.com/".concat(e)).replace(ia, "") +
                  "/edit/".concat(r) +
                  (n ? "/" + n.replace(ia, "") : "") +
                  o;
          }
    ...
    var za = {
        ...
        render: function(t, e) {
          ...
          return "auto" === a.type
            ? [u, Wa(t, a.children, a.basePath, i, f)]
            : (c || p) && a.headers && !ra.test(a.path)
              ? [u, Wa(t, da(a.headers), a.path, i, f)]
              : u;
        }
      },
    ...
    var Ka = Ga.exports,
      Xa = {
        ...
        components: { SidebarLink: Ka, DropdownTransition: Ta }
      },
      Ya = (n(138),
      Object(ga.a)(
        Xa,
        function() {
          ...
          return n(
            "div",
            { staticClass: "sidebar-group", class: { first: t.first, collapsable: t.collapsable } },
            [
              n(
                "p",
                {
                ...
                t.open || !t.collapsable
                  ? n(
                      ...
                      t._l(t.item.children, function(t) {
                        return n("li", [n("SidebarLink", { attrs: { item: t } })], 1);
                      })
                    )
                  : t._e()
              ])
        ...
        computed: {
          popupConfig: function() {
            for (var t = [this.$themeLocaleConfig, this.$site.themeConfig], e = 0; e < t.length; e++) {
              ...
              if (n && n.updatePopup) return "object" === es(n.updatePopup) ? n.updatePopup : {};
            }
            return null;
          },
          enabled: function() {
          ...
          return n("transition", { attrs: { name: "sw-update-popup" } }, [
            t.enabled
              ? n("div", { staticClass: "sw-update-popup" }, [
                  ...
                  n("br"),
                  t._v(" "),
                  n("button", { on: { click: t.reload } }, [t._v(t._s(t.buttonText))])
                ])
              : t._e()
          ]);
        },
    ...
    var os = {
        components: { Home: ka, Page: qa, Sidebar: Za, Navbar: Ua, SWUpdatePopup: rs.exports },
        data: function() {
          ...
          return n(
            ...
            [
              ...
              t.$page.frontmatter.layout
                ? n("div", { staticClass: "custom-layout" }, [n(t.$page.frontmatter.layout, { tag: "component" })], 1)
        ...
        mounted: function() {
          ...
          var e = function() {
            ...
            0 ===
              ...
              }).length && n.push({ name: "description", content: t.$description });
          ...
          methods: {
            ...
            setActiveHash: function() {
              for (
                ...
                if (
                  ((0 === o && 0 === r) ||
                    (r >= i.parentElement.offsetTop + 10 && (!a || r < a.parentElement.offsetTop - 10))) &&
                  decodeURIComponent(this.$route.hash) !== decodeURIComponent(i.hash)
                )
                  return (
                    (ta.disableScrollBehavior = !0),
                    void this.$router.replace(decodeURIComponent(i.hash), function() {
                      t.$nextTick(function() {
    ...
    yo.component("Discodip", function() {
      return n.e(3).then(n.bind(null, 174));
    }),
      yo.component("Todo", function() {
        return n.e(4).then(n.bind(null, 175));
      }),
      Zi(as, hs),
      Zi(ls, hs);
    var vs = [
        {
          name: "v-45c1bf10781b5",
          path: "/",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(5)
              ...
              .then(function(t) {
                yo.component("v-45c1bf10781b5", t.default), r();
              });
          }
        },
        { path: "/index.html", redirect: "/" },
        {
          name: "v-040582a9d9268",
          path: "/components/",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(6)
              ...
              .then(function(t) {
                yo.component("v-040582a9d9268", t.default), r();
              });
          }
        },
        { path: "/components/index.html", redirect: "/components/" },
        {
          name: "v-b468882eadcb1",
          path: "/components/atoms/buttons.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(7)
              .then(n.bind(null, 217))
              .then(function(t) {
                yo.component("v-b468882eadcb1", t.default), r();
              });
          }
        },
        {
          name: "v-320e1707b40be",
          path: "/components/content/collapsibles.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(8)
              .then(n.bind(null, 202))
              .then(function(t) {
                yo.component("v-320e1707b40be", t.default), r();
              });
          }
        },
        {
          name: "v-da9dabb89bd2e",
          path: "/components/content/richtext.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(9)
              .then(n.bind(null, 218))
              .then(function(t) {
                yo.component("v-da9dabb89bd2e", t.default), r();
              });
          }
        },
        {
          name: "v-78570b5bd2bcd",
          path: "/components/content/textmedia-regular.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(10)
              .then(n.bind(null, 215))
              .then(function(t) {
                yo.component("v-78570b5bd2bcd", t.default), r();
              });
          }
        },
        {
          name: "v-f88f913eb6af8",
          ...
          beforeEnter: function(t, e, r) {
            n.e(11)
              ...
              .then(function(t) {
                yo.component("v-f88f913eb6af8", t.default), r();
              });
          }
        },
        { path: "/components/todo/index.html", redirect: "/components/todo/" },
        {
          name: "v-cf0ce763ee4dd",
          path: "/components/todo/bio.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(12)
              .then(n.bind(null, 211))
              .then(function(t) {
                yo.component("v-cf0ce763ee4dd", t.default), r();
              });
          }
        },
        {
          name: "v-dd8c722ea61cf",
          path: "/components/todo/cards.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(13)
              .then(n.bind(null, 201))
              .then(function(t) {
                yo.component("v-dd8c722ea61cf", t.default), r();
              });
          }
        },
        {
          name: "v-ab2c0b37dd297",
          path: "/components/todo/carousel.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(14)
              .then(n.bind(null, 200))
              .then(function(t) {
                yo.component("v-ab2c0b37dd297", t.default), r();
              });
          }
        },
        {
          name: "v-394143a6d2478",
          path: "/components/todo/contact.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(15)
              .then(n.bind(null, 199))
              .then(function(t) {
                yo.component("v-394143a6d2478", t.default), r();
              });
          }
        },
        {
          name: "v-eaef47c06eb38",
          path: "/components/todo/course-hero.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(16)
              .then(n.bind(null, 198))
              .then(function(t) {
                yo.component("v-eaef47c06eb38", t.default), r();
              });
          }
        },
        {
          name: "v-78c0839b8c26e",
          path: "/components/todo/cta.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(17)
              .then(n.bind(null, 197))
              .then(function(t) {
                yo.component("v-78c0839b8c26e", t.default), r();
              });
          }
        },
        {
          name: "v-87ea4e733ee56",
          path: "/components/todo/facts.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(18)
              .then(n.bind(null, 219))
              .then(function(t) {
                yo.component("v-87ea4e733ee56", t.default), r();
              });
          }
        },
        {
          name: "v-61c8b358e883e",
          path: "/components/todo/filters.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(19)
              .then(n.bind(null, 195))
              .then(function(t) {
                yo.component("v-61c8b358e883e", t.default), r();
              });
          }
        },
        {
          name: "v-b43849c896dd4",
          path: "/components/todo/image-list.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(20)
              .then(n.bind(null, 194))
              .then(function(t) {
                yo.component("v-b43849c896dd4", t.default), r();
              });
          }
        },
        {
          name: "v-d0ef710381687",
          path: "/components/todo/images.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(21)
              .then(n.bind(null, 193))
              .then(function(t) {
                yo.component("v-d0ef710381687", t.default), r();
              });
          }
        },
        {
          name: "v-1821ea1b125af",
          path: "/components/todo/link-list.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(22)
              .then(n.bind(null, 210))
              .then(function(t) {
                yo.component("v-1821ea1b125af", t.default), r();
              });
          }
        },
        {
          name: "v-450b5a35f55b9",
          path: "/components/todo/maps.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(23)
              .then(n.bind(null, 191))
              .then(function(t) {
                yo.component("v-450b5a35f55b9", t.default), r();
              });
          }
        },
        {
          name: "v-b68ed7f7d2186",
          path: "/components/todo/navigation.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(24)
              .then(n.bind(null, 190))
              .then(function(t) {
                yo.component("v-b68ed7f7d2186", t.default), r();
              });
          }
        },
        {
          name: "v-640412609a663",
          path: "/components/todo/quote.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(25)
              .then(n.bind(null, 189))
              .then(function(t) {
                yo.component("v-640412609a663", t.default), r();
              });
          }
        },
        {
          name: "v-e3c6f99dd2285",
          path: "/components/todo/route.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(26)
              .then(n.bind(null, 188))
              .then(function(t) {
                yo.component("v-e3c6f99dd2285", t.default), r();
              });
          }
        },
        {
          name: "v-7aecfc184ee17",
          path: "/components/todo/sliders.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(27)
              .then(n.bind(null, 187))
              .then(function(t) {
                yo.component("v-7aecfc184ee17", t.default), r();
              });
          }
        },
        {
          name: "v-8995d420379f4",
          path: "/components/todo/specials.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(28)
              .then(n.bind(null, 186))
              .then(function(t) {
                yo.component("v-8995d420379f4", t.default), r();
              });
          }
        },
        {
          name: "v-792e9ad41a641",
          path: "/components/todo/tables.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(29)
              .then(n.bind(null, 185))
              .then(function(t) {
                yo.component("v-792e9ad41a641", t.default), r();
              });
          }
        },
        {
          name: "v-bce1d468246ac",
          path: "/components/todo/tabs.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(30)
              .then(n.bind(null, 184))
              .then(function(t) {
                yo.component("v-bce1d468246ac", t.default), r();
              });
          }
        },
        {
          name: "v-237d9a3d5ae97",
          path: "/components/todo/takeover.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(31)
              .then(n.bind(null, 183))
              .then(function(t) {
                yo.component("v-237d9a3d5ae97", t.default), r();
              });
          }
        },
        {
          name: "v-3046b5c596528",
          path: "/components/todo/testimonial.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(32)
              .then(n.bind(null, 182))
              .then(function(t) {
                yo.component("v-3046b5c596528", t.default), r();
              });
          }
        },
        {
          name: "v-2b4a00c0d84a9",
          path: "/components/todo/text-list.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(33)
              .then(n.bind(null, 181))
              .then(function(t) {
                yo.component("v-2b4a00c0d84a9", t.default), r();
              });
          }
        },
        {
          name: "v-b1109b7265798",
          path: "/components/todo/text.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(34)
              .then(n.bind(null, 180))
              .then(function(t) {
                yo.component("v-b1109b7265798", t.default), r();
              });
          }
        },
        {
          name: "v-f85550e05555",
          path: "/components/todo/textmedia-fat.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(35)
              .then(n.bind(null, 179))
              .then(function(t) {
                yo.component("v-f85550e05555", t.default), r();
              });
          }
        },
        {
          name: "v-5bad4fa9d1c2f",
          path: "/components/todo/textmedia-highlight.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(36)
              .then(n.bind(null, 178))
              .then(function(t) {
                yo.component("v-5bad4fa9d1c2f", t.default), r();
              });
          }
        },
        {
          name: "v-1a711e6f678c6",
          path: "/components/todo/textmedia-skinny.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(37)
              .then(n.bind(null, 177))
              .then(function(t) {
                yo.component("v-1a711e6f678c6", t.default), r();
              });
          }
        },
        {
          name: "v-4ec5171e98c58",
          path: "/components/todo/textmedia-whale.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(38)
              .then(n.bind(null, 176))
              .then(function(t) {
                yo.component("v-4ec5171e98c58", t.default), r();
              });
          }
        },
        {
          name: "v-a90d4aeae0b4c",
          path: "/components/todo/tooltip.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(39)
              .then(n.bind(null, 212))
              .then(function(t) {
                yo.component("v-a90d4aeae0b4c", t.default), r();
              });
          }
        },
        {
          name: "v-5bcabe057386c",
          path: "/components/todo/video.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(40)
              .then(n.bind(null, 209))
              .then(function(t) {
                yo.component("v-5bcabe057386c", t.default), r();
              });
          }
        },
        {
          name: "v-b4d9e8042f6d2",
          path: "/design/",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(41)
              ...
              .then(function(t) {
                yo.component("v-b4d9e8042f6d2", t.default), r();
              });
          }
        },
        { path: "/design/index.html", redirect: "/design/" },
        {
          name: "v-18e4908e20889",
          ...
          beforeEnter: function(t, e, r) {
            n.e(42)
              ...
              .then(function(t) {
                yo.component("v-18e4908e20889", t.default), r();
              });
          }
        },
        {
          name: "v-fa0fceb9e8592",
          path: "/design/rules.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(43)
              .then(n.bind(null, 206))
              .then(function(t) {
                yo.component("v-fa0fceb9e8592", t.default), r();
              });
          }
        },
        {
          name: "v-ee4063f0c85a8",
          path: "/docs/",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(44)
              ...
              .then(function(t) {
                yo.component("v-ee4063f0c85a8", t.default), r();
              });
          }
        },
        { path: "/docs/index.html", redirect: "/docs/" },
        {
          name: "v-42eb759eaf6cf",
          path: "/docs/iconen.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(45)
              .then(n.bind(null, 204))
              .then(function(t) {
                yo.component("v-42eb759eaf6cf", t.default), r();
              });
          }
        },
        {
          name: "v-7e0eda9bd7cbd",
          path: "/docs/typografie.html",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(46)
              .then(n.bind(null, 203))
              .then(function(t) {
                yo.component("v-7e0eda9bd7cbd", t.default), r();
              });
          }
        },
        {
          name: "v-870929648a5de",
          path: "/templates/",
          component: as,
          beforeEnter: function(t, e, r) {
            n.e(47)
              ...
              .then(function(t) {
                yo.component("v-870929648a5de", t.default), r();
              });
          }
        },
        { path: "/templates/index.html", redirect: "/templates/" },
        { path: "*", component: ls }
      ],
      ms = {
        ...
        pages: [
          ...
          },
          {
            ...
            title: "Components",
            headers: [
              { level: 2, title: "Naamgeving", slug: "naamgeving" },
              { level: 2, title: "Visual Loudness Scale", slug: "visual-loudness-scale" },
              { level: 3, title: "De schaal", slug: "de-schaal" },
              { level: 2, title: "Visual Wideness Scale", slug: "visual-wideness-scale" },
              { level: 3, title: "De schaal", slug: "de-schaal-2" }
            ]
          },
          {
            key: "v-b468882eadcb1",
            ...
            title: "Knoppen",
            headers: [
              { level: 2, title: "Knop (Primair)", slug: "knop-primair" },
              { level: 2, title: "Knop (Secundair)", slug: "knop-secundair" },
              { level: 2, title: "Knop (Strong link)", slug: "knop-strong-link" },
              { level: 2, title: "Button hierarchie opties", slug: "button-hierarchie-opties" }
            ]
          },
          { key: "v-320e1707b40be", path: "/components/content/collapsibles.html", title: "Uitklappers" },
          {
            key: "v-da9dabb89bd2e",
            path: "/components/content/richtext.html",
            title: "Richtext",
            headers: [
              { level: 2, title: "Eenvoudig", slug: "eenvoudig" },
              { level: 2, title: "Intro", slug: "intro" },
              { level: 2, title: "Tabel", slug: "tabel" },
              { level: 2, title: "Volledig", slug: "volledig" }
            ]
          },
          {
            key: "v-78570b5bd2bcd",
            path: "/components/content/textmedia-regular.html",
            title: "Tekst en Media Regular",
            headers: [
              { level: 2, title: "Foto links", slug: "foto-links" },
              { level: 2, title: "Foto rechts", slug: "foto-rechts" },
              { level: 2, title: "Video links", slug: "video-links" },
              { level: 2, title: "Video rechts", slug: "video-rechts" }
            ]
          },
          { key: "v-f88f913eb6af8", path: "/components/todo/" },
          { key: "v-cf0ce763ee4dd", path: "/components/todo/bio.html", title: "Bio and testimonial" },
          { key: "v-dd8c722ea61cf", path: "/components/todo/cards.html", title: "Cards" },
          { key: "v-ab2c0b37dd297", path: "/components/todo/carousel.html", title: "Carousel" },
          {
            key: "v-394143a6d2478",
            path: "/components/todo/contact.html",
            title: "Contact",
            headers: [{ level: 2, title: "Conditionals:", slug: "conditionals" }]
          },
          { key: "v-eaef47c06eb38", path: "/components/todo/course-hero.html", title: "Heroes" },
          { key: "v-78c0839b8c26e", path: "/components/todo/cta.html", title: "Call for Action" },
          { key: "v-87ea4e733ee56", path: "/components/todo/facts.html", title: "Facts" },
          { key: "v-61c8b358e883e", path: "/components/todo/filters.html", title: "Filters" },
          { key: "v-b43849c896dd4", path: "/components/todo/image-list.html", title: "Image-List" },
          {
            key: "v-d0ef710381687",
            path: "/components/todo/images.html",
            title: "Images",
            headers: [
              { level: 2, title: "Image row", slug: "image-row" },
              { level: 2, title: "Image grid", slug: "image-grid" }
            ]
          },
          { key: "v-1821ea1b125af", path: "/components/todo/link-list.html", title: "Link-List" },
          {
            key: "v-450b5a35f55b9",
            path: "/components/todo/maps.html",
            title: "Maps",
            headers: [
              { level: 2, title: "Concept:", slug: "concept" },
              { level: 2, title: "Notes voor dev:", slug: "notes-voor-dev" },
              { level: 2, title: "Notes voor content:", slug: "notes-voor-content" }
            ]
          },
          { key: "v-b68ed7f7d2186", path: "/components/todo/navigation.html", title: "Navigation" },
          { key: "v-640412609a663", path: "/components/todo/quote.html", title: "Quote" },
          { key: "v-e3c6f99dd2285", path: "/components/todo/route.html", title: "Route" },
          {
            key: "v-7aecfc184ee17",
            path: "/components/todo/sliders.html",
            title: "Sliders",
          ...
          { key: "v-8995d420379f4", path: "/components/todo/specials.html", title: "Specials" },
          { key: "v-792e9ad41a641", path: "/components/todo/tables.html", title: "Tables" },
          { key: "v-bce1d468246ac", path: "/components/todo/tabs.html", title: "Tabs" },
          { key: "v-237d9a3d5ae97", path: "/components/todo/takeover.html", title: "Takeover" },
          { key: "v-3046b5c596528", path: "/components/todo/testimonial.html", title: "Testimonial" },
          { key: "v-2b4a00c0d84a9", path: "/components/todo/text-list.html", title: "Text-List" },
          { key: "v-b1109b7265798", path: "/components/todo/text.html", title: "Text" },
          { key: "v-f85550e05555", path: "/components/todo/textmedia-fat.html", title: "Tekst en Media Fat" },
          {
            key: "v-5bad4fa9d1c2f",
            path: "/components/todo/textmedia-highlight.html",
            title: "Tekst en Media Highlight"
          },
          { key: "v-1a711e6f678c6", path: "/components/todo/textmedia-skinny.html", title: "Tekst en Media Skinny" },
          { key: "v-4ec5171e98c58", path: "/components/todo/textmedia-whale.html", title: "Text en Media Whale" },
          { key: "v-a90d4aeae0b4c", path: "/components/todo/tooltip.html", title: "Tooltip" },
          { key: "v-5bcabe057386c", path: "/components/todo/video.html", title: "Video" },
          { key: "v-b4d9e8042f6d2", path: "/design/" },
          {
            key: "v-18e4908e20889",
            path: "/design/principles.html",
            title: "Design Principles",
            headers: [
              { level: 2, title: "Universal Design Principles", slug: "universal-design-principles" },
              { level: 3, title: "Menselijk", slug: "menselijk" },
              { level: 3, title: "Ruimtelijk", slug: "ruimtelijk" },
              { level: 3, title: "Activerend", slug: "activerend" },
              { level: 3, title: "Betrouwbaar", slug: "betrouwbaar" },
              { level: 3, title: "Consistent", slug: "consistent" },
              { level: 3, title: "Toegankelijk", slug: "toegankelijk" },
              { level: 2, title: "Specific Design Principles", slug: "specific-design-principles" },
              { level: 3, title: "Layered weight", slug: "layered-weight" },
              { level: 3, title: "Ruimte", slug: "ruimte" }
            ]
          },
          {
            key: "v-fa0fceb9e8592",
            ...
            headers: [
              ...
              { level: 3, title: "Concept", slug: "concept" },
              { level: 3, title: "Technisch", slug: "technisch" }
            ]
          },
          {
            key: "v-ee4063f0c85a8",
            path: "/docs/",
            title: "HAN.nl Frontend Docs",
            headers: [
              { level: 2, title: "Development", slug: "development" },
              { level: 3, title: "Compile sass, pug, js", slug: "compile-sass-pug-js" },
              { level: 3, title: "Vuepress dev", slug: "vuepress-dev" },
              { level: 3, title: "Vuepress prod", slug: "vuepress-prod" },
              { level: 2, title: "Watch / build", slug: "watch-build" },
              { level: 2, title: "Single build", slug: "single-build" },
              { level: 2, title: "Netlify", slug: "netlify" },
              { level: 2, title: "Afbeeldingen imgix", slug: "afbeeldingen-imgix" },
              { level: 2, title: "Mappenstructuur", slug: "mappenstructuur" }
            ]
          },
          {
            key: "v-42eb759eaf6cf",
            ...
            title: "Iconen",
            headers: [
              { level: 2, title: "Iconen", slug: "iconen" },
              { level: 2, title: "Laadtijd", slug: "laadtijd" },
              { level: 2, title: "Alleen iconen", slug: "alleen-iconen" },
              { level: 2, title: "Stappen voor toevoegen nieuw icoon", slug: "stappen-voor-toevoegen-nieuw-icoon" }
            ]
          },
          {
            key: "v-7e0eda9bd7cbd",
            path: "/docs/typografie.html",
            title: "Typografie",
            headers: [{ level: 2, title: "Typografie", slug: "typografie" }]
          },
          { key: "v-870929648a5de", path: "/templates/", title: "Templates" }
        ],
        themeConfig: {
          lastUpdated: "",
          ...
          sidebar: [
            ...
            },
            {
              title: "Design",
              collapsible: !0,
              children: [["design/", "Design"], ["design/rules", "Rules"], ["design/principles", "Principles"]]
            },
            {
              title: "Docs",
              collapsible: !0,
              children: [["docs/", "Docs"], ["docs/iconen", "Iconen"], ["docs/typografie", "Typografie"]]
            }
          ]
        }
      },
      ...
      bs = {
        ...
        render: function(t, e) {
          var n = e.parent,
            r = e.props,
            o = e.data;
          return t(n.$page.key, { class: [r.custom ? "custom" : "", o.class, o.staticClass], style: o.style });
        }
      },
      _s = (n(153),
      Object(ga.a)(
    ...
    _s.options.__file = "OutboundLink.vue";
    var xs = _s.exports;
    n.e(1).then(n.t.bind(null, 173, 7)),
          ...
          return {
            computed: {
              ...
              $description: function() {
                ...
                return (
                  this.$page.frontmatter.description || this.$localeConfig.description || this.$site.description || ""
                );
              },
              $lang: function() {
      ...
      yo.component("Content", bs),
      yo.component("OutboundLink", xs),
      yo.component("Badge", function() {
        return n.e(2).then(n.bind(null, 196));
      }),
    ...
    var ks = (function() {
        var t = new Ji({
          ...
          scrollBehavior: function(t, e, n) {
            return n || (t.hash ? !ta.disableScrollBehavior && { selector: t.hash } : { x: 0, y: 0 });
          }
        });
        t.beforeEach(function(t, e, n) {
          /(\/|\.html)$/.test(t.path) ? n() : n(Object.assign({}, t, { path: t.path + "/" }));
        });
        var e = {};
        return (
          ...
          gs({ Vue: yo, options: e, router: t, siteData: ms }),
          {
            app: new yo(
              Object.assign(e, {
                router: t,
                render: function(t) {
                  return t("div", { attrs: { id: "app" } }, [t("router-view", { ref: "layout" })]);
                }
              })
            ),
            router: t
      ...
      ws = ks.app,
      Cs = ks.router;
    (window.__VUEPRESS_VERSION__ = { version: "0.14.4", hash: "19808ca" }),
      Cs.onReady(function() {
        ws.$mount("#app");
      });
  }
